...
class Connection(abstract.FileDescriptor, _SocketCloser):
    ...
    if SSL:
        ...
        def startTLS(self, ctx, extra):
            ...
            if hasattr(self, 'app_data'): # JY ADDED
                self.socket.set_app_data(self.app_data)
            if hasattr(self, 'tlsext_host_name'): # JY ADDED
                self.socket.set_tlsext_host_name(self.tlsext_host_name)
